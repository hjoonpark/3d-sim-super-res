...
def load_config(mode: str):
    ...
    if mode == 'train':
        ...
        parser.add_argument('--n_epochs', type=int, default=1000, help='number of trainning epochs')
        parser.add_argument('--lr', type=float, default=2e-4, help='learning rate')
        parser.add_argument('--lr_decay_epoch', type=int, default=1500, help='learning rate decay frequency')
        ...
        parser.add_argument('--plot_iter', type=int, default=500, help='print frequency')
        parser.add_argument('--train_ckpt_iter', type=int, default=500, help='checkpoint frequency')
        parser.add_argument('--train_ckpt_n_max', type=int, default=3, help='number of training results to save')
        parser.add_argument('--save_model_epoch', type=int, default=1000, help='model saving frequency')
