...
def load_config(mode: str):
    ...
    if mode == 'train':
        ...
        parser.add_argument('--plot_epoch', type=int, default=100, help='print frequency')
        parser.add_argument('--train_ckpt_epoch', type=int, default=100, help='checkpoint frequency')
        parser.add_argument('--train_ckpt_n_max', type=int, default=3, help='number of training results to save')
        parser.add_argument('--save_model_epoch', type=int, default=200, help='model saving frequency')
