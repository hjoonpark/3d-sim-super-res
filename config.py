...
def load_config(mode: str):
    ...
    if mode == 'train':
        ...
        parser.add_argument('--plot_iter', type=int, default=50, help='print frequency')
        parser.add_argument('--train_ckpt_iter', type=int, default=50, help='checkpoint frequency')
